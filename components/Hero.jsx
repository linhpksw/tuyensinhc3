            ...
            <Container className='flex items-start flex-wrap lg:flex-nowrap lg:gap-10'>
                <div id='about' className='flex items-center w-full lg:w-1/2'>
                    <div className='max-w-2xl mb-8 lg:mb-0'>
                        ...
                        <p className='pt-3 pb-1 text-gray-500 text-[1rem] md:text-[1.06rem]  leading-8'>
                        ...
                        <p className='pb-1 text-gray-500 text-[1rem] md:text-[1.06rem] leading-8'>
                            • Lớp 10A0 - Lớp vận dụng cao, dành cho các học sinh lớp chuyên toán lý hóa các trường chuyên, lớp chọn khối A và A1 trường LTV, LQĐ với mục tiêu điểm 9-10 môn toán thi đại học. Điều kiện xét tuyển đầu vào của lớp là HS lớp chuyên toán lý hoá các trường chuyên hoặc HS trường thường có điểm thi vào 10 môn toán từ 9,5 trở lên.
                        </p>
                        <p className='text-gray-500 text-[1rem] md:text-[1.06rem] leading-8'>
                            • Lớp 10A1 - Lớp toán nâng cao, dành cho các học sinh khá giỏi các trường THPT, với mục tiêu điểm 9 môn toán thi đại học. Điều kiện xét tuyển đầu vào của lớp là điểm thi vào 10 môn toán từ 8,5 trở lên.
                        </p>


                        <form onSubmit={handleForm} className='lg:hidden mt-5 sm:flex sm:w-full sm:max-w-lg'>
                ...
                <div className='hidden lg:block'>
                    ...
                    <form onSubmit={handleForm} className='flex mt-8 w-full max-w-lg'>
                        ...
                        <div className='ml-3'>
                            <button
                                type='submit'
                                disabled={isLoading}
                                className={`block w-full rounded-md border border-transparent bg-rose-500 px-10 py-3 text-base font-medium text-white shadow hover:bg-rose-600 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 ${isLoading ? 'cursor-wait opacity-50' : ''}`}>
                                {isLoading ? (
                                    <>
                                        <svg aria-hidden="true" role="status" className="inline w-4 h-4 mr-3 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z" fill="#E5E7EB" />
